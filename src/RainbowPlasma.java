...
class RainbowPlasma extends PApplet {
  ...
  public RainbowPlasma(Tunnel t, int w, int h, String p) {
    width = w;
    height = h;
    tunnel = t;
    position = p;
  ...
  public void setup() {
    ...
    for (int v = 0; v < 3; v++)
    {
      ...
      coords[v][6] = random((float)0.002, (float)0.005);
      coords[v][7] = random((float)0.002, (float)0.005);
      coords[v][8] = random((float)0.002, (float)0.005);
    }
    a1 = random(TWO_PI);
    ai1 = (float)0.1;
    background(255);
